            ...
            <section className='section-login flex justify-center items-center h-screen relative'>
                ...
                <div className="container-login bg-white max-w-[95%] px-8 py-14 rounded-2xl">
                    ...
                    <div className="login-btn text-center w-full">
                        <Link href={"/"} className='btn-primary w-full block'>Get started</Link>
                    </div>
                    ...
                    <div className="login-apps">
                        <Link href={"/"}>
                            <Image src={"/assets/images/icons/playstore.png"} sizes='100' width={0} height={0} alt='play store'></Image>
                        </Link>

                        <Link href={"/"}>
                            <Image src={"/assets/images/icons/appstore.png"} width={0} sizes='100' height={0} alt='play store'></Image>
                        </Link>
                    </div>
                </div>
            </section>
