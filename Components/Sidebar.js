                        ...
                        {userInfoHovered && (
                            isPublished ? (
                                <div className="create-patreon-container">
                                    <div class="close flex justify-center items-center rounded-full w-[20px] h-[20px] absolute top-2 right-2 z-10 cursor-pointer" onClick={() => setUserInfoHovered(false)}>
